      ...
      <div className="container flex h-14 items-center">
        <div className="mr-4 flex">
          <Link href="/" className="mr-6 flex items-center space-x-2">
            <span className="font-bold text-sage dark:text-sage-dark">&lt;</span>
            <span className="font-bold text-lightpink dark:text-lightpink-dark">sneha</span>
            <span className="font-bold text-sage dark:text-sage-dark">/&gt;</span>
          </Link>
        </div>
          ...
          {["about", "skills", "projects"].map((section) => (
            <button
              ...
              className={`text-sm font-medium transition-colors hover:text-sage dark:hover:text-sage-dark ${
                activeSection === section ? "text-sage dark:text-sage-dark" : "text-lightpink dark:text-lightpink-dark"
              }`}
            >
