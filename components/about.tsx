...
import { Github, Linkedin, Mail, Code, Globe, FileCode, Palette } from 'lucide-react'
  ...
  return (
    <section id="about" className="py-20 container mx-auto px-4">
      <div className="flex flex-col md:flex-row items-start gap-8">
        ...
        >
          <h2 className="text-4xl font-bold mb-6 text-sage dark:text-sage-dark">About Me</h2>
          <p className="text-lg mb-8 text-sage dark:text-sage-dark max-w-2xl mx-auto leading-relaxed">
            I'm a passionate Full Stack Developer with expertise in modern web technologies. 
            With a strong foundation in both frontend and backend development, 
            I love bringing ideas to life through clean, maintainable code and intuitive user experiences.
          </p>
          <div className="flex justify-center gap-4 mb-10">
            <Button asChild variant="outline" size="icon" className="bg-gray-800 hover:bg-gray-700 dark:bg-gray-200 dark:hover:bg-gray-300 transition-colors duration-300">
          ...
          <div id="skills">
            <h3 className="text-2xl font-semibold mb-6 text-lightpink dark:text-lightpink-dark">Skills</h3>
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6 max-w-3xl mx-auto">
              {skills.map((skill) => (
                ...
                >
                  ...
                  <span className="text-sm font-medium text-sage dark:text-sage-dark">{skill.name}</span>
                </motion.div>
              ))}
            </div>
          </div>
